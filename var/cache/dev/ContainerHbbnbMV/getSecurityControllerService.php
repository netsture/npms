...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.mMWeBGH'] ?? $container->load('get_ServiceLocator_MMWeBGHService'))->withContext('App\\Controller\\SecurityController', $container));
